...
import com.mohitmehta317.materialdatetimepicker.date.MonthAdapter.CalendarDay;
...
public abstract class MonthView extends View {
    ...
    protected void initView() {
        ...
        //change the typeface for the Month Title
        mMonthTitlePaint.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_bold));
       ...
       // mMonthTitlePaint.setTypeface(Typeface.create(mMonthTitleTypeface, Typeface.BOLD));
        ...
        //change the typeface for the Month Title
        mMonthDayLabelPaint.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_bold));
