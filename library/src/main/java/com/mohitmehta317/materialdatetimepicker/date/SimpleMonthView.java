...
public class SimpleMonthView extends MonthView {
    ...
    public void drawMonthDay(Canvas canvas, int year, int month, int day,
        ...
        if (isHighlighted(year, month, day) && mSelectedDay != day) {
            ...
            mMonthNumPaint.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_semi_bold));
        } else {
            mMonthNumPaint.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_medium));
        }
        ...
        if (mController.isOutOfRange(year, month, day)) {
            ...
            mMonthNumPaint.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_bold));
