...
import com.mohitmehta317.materialdatetimepicker.date.DatePickerDialog.OnDateChangedListener;
    ...
    private final class YearAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                v.setTypeface(ResourcesCompat.getFont(context, R.font.montserrat_medium));
            }
