...
package com.mohitmehta317.materialdatetimepicker.date;
...
import com.mohitmehta317.materialdatetimepicker.HapticFeedbackController;
import com.mohitmehta317.materialdatetimepicker.R;
import com.mohitmehta317.materialdatetimepicker.Utils;
...
public class DatePickerDialog extends AppCompatDialogFragment implements
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callback) {
        ...
        return newInstance(callback, now);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
      ...
      //  okButton.setTypeface(ResourcesCompat.getFont(activity, R.font.robotomedium));
        ...
        cancelButton = view.findViewById(R.id.mdtp_cancel);
        ...
        setBoldTypeFace(mDatePickerHeaderView,mSelectedMonthTextView,mSelectedDayTextView,mYearView,okButton,cancelButton);
    ...
    public void setBoldTypeFace(View... view){
        try {
            Typeface face = Typeface.createFromAsset(getResources().getAssets(),
                    "fonts/montserrat_semi_bold.ttf");
